  ...
  return (
    <div className="flex flex-col bg-gray-800 text-white w-64 h-screen fixed">
      ...
      <nav className="flex-grow flex flex-col gap-4 p-4">
        <Link
          href="http://localhost:3001/coordinator_panel"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Main Panel
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/tasks"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Tasks
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/addTask"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Add Task
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/addDriver"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Add Driver
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/addTruck"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Add Truck
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/report"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Report
        </Link>
        <Link
          href="http://localhost:3001/coordinator_panel/chat"
          className="hover:bg-gray-700 p-2 rounded-md transition-colors"
        >
          Chat
        </Link>
      ...
      {showModal && (
        <Modal
          ...
          timeRemaining={Math.max(
            0,
            (remainingTime || 0) - FORCE_LOGOUT_THRESHOLD
          )}
        />
      )}
    </div>
